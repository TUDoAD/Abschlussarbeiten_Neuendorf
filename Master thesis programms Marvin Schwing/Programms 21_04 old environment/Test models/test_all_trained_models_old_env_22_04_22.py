...
DQN = tf.keras.models.load_model(r'C:/Users/marvi/sciebo/Masterarbeit/Model/DQN_old_env2022_04_25 12_39.h5')
...
DDPG =  tf.keras.models.load_model(r'C:/Users/marvi/sciebo/Masterarbeit/Model/DDPG_optimised_net_old_env2022_04_26 15_03.h5')
#DDPG =  tf.keras.models.load_model(r'C:/Users/marvi/DDPG_model_02_03_22_1.h5')

with open(r'C:/Users/marvi/sciebo/Masterarbeit/Model/Q_table_old_env2022_04_22 12_16.pkl', 'rb') as f:
...
own_env_con = con_env.ExtractionEnv_con(wanted_drop_size, theta, excel_data, reward_weights)
#%%DQN
...
#%% DDPG
for episode in range(1, episodes+1):
    teststate = own_env_con.set_reset(550,35)
    done = False
    score = 0
    DDPGdrop = []
    DDPGrpm  = []
    ...
    while not done:
        ...
        print(action)
        del new_s
        teststate, reward, done, info = own_env_con.step(action)
        #print(state)
        score+=reward
