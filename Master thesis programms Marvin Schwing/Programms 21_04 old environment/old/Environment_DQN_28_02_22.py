...
class DQNAgent:
    ...
    def __init__(
            ...
            epsilon_decay=0.999, learning_rate=1e-3,max_memory_size = 1000):
        self.enf = env
        self.state_size = 1
    ...
    def save_model(self):
        self.model.save_weights('DQN_weights_28_02_22_1',overwrite = True)
        self.model.save('DQN_model_28_02_22_1.h5')
...
if __name__ == '__main__':
    env = ExtractionEnv(wanted_size, all_theta, data_2, [0.6,0.2,0.6,1]) 
    testEnv = ExtractionEnv(wanted_size, all_theta, data_2, [0.6,0.2,0.6,1])
    agent = DQNAgent(env)
    drop_avg = 0
    ...
    for l in range(init_replay_memory_size):
        ...
        agent.remember(Transition(new_s, action, reward, new_s2, done),action)
