...
con_env = SourceFileLoader("Environment_con_with_aceton_28_03_22.py", r"C:/Users/marvi/sciebo/Masterarbeit/Programms 11_04 new environment/Environments/Environment_con_with_aceton_28_03_22.py").load_module()
...
def ddpg(env_fn,
    ...
    def test_agent(num_episodes=5):
        ...
        for j in range(num_episodes):
            ...
            new_s[4]=new_s[4]/2
            start = time.time()
            while not (d or (e_length == max_episode_length)):
            ...
            if e_return > 0:
                ...
                if len(early_stopping) == 5:
                    ...
                    for stopping in early_stopping:
                        if stopping<100: #for opt training 450
                            stop = False
    ...
    print('overall time training {}'.format(end_training-start_training))
    return (returns,steps,critic_losses,actor_losses, actor)
#%%
#start training
returns, steps, critic_losses,actor_losses, actor = ddpg(own_env)

#%%
#manually save the actor network
actor.save(r'C:/Users/marvi/sciebo/Masterarbeit/Model/DDPG_optimised_net_new_env_new_reward_new_stopping'+ datetime.datetime.today().strftime('%Y_%m_%d %H_%M')+'.h5')
