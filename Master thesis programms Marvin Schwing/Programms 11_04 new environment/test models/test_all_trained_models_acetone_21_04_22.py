...
DDPG =  tf.keras.models.load_model(r'C:/Users/marvi/sciebo/Masterarbeit/Model/DDPG_optimised_net_new_env_new_reward_new_stopping2022_04_28 15_28.h5')
...
con_env_load = SourceFileLoader("Environment_con_with_aceton_28_03_22.py", r"C:/Users/marvi/sciebo/Masterarbeit/Programms 11_04 new environment/Environments/Environment_con_with_aceton_28_03_22.py").load_module()

dis_env = dis_env_load.ExtractionEnv_dis(wanted_acetone_conc, theta, excel_data, reward_weights,10)

con_env = con_env_load.ExtractionEnv_con(wanted_acetone_conc, theta, excel_data, reward_weights)
#%%DQN
...
#%% DDPG
for episode in range(1, episodes+1):
    teststate = con_env.set_reset(550,20)
    done = False
    score = 0
    DDPGdrop = []
    DDPGrpm  = []
